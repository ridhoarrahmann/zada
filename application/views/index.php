...
<body class="d-flex flex-column h-100">
    <main class="flex-shrink-0">
        ...
        <div class="header-container" style="background-image: url(<?= base_url('assets/img/') ?>header.jpg);"
                        ...
                        <div class="col-lg-8 col-xl-7 col-xxl-6">
                            <div class="my-5 text-center text-xl-start">
                                ...
                                <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                                    <a class="btn btn-secondary btn-lg px-7 me-sm-3"
                                        href="https://www.instagram.com/batikbumien/">Tentang</a>
                                    <a class="btn btn-outline-light btn-lg px-7" href="">Lainnya</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img
                                src="<?= base_url('assets/img/') ?>Mbatik-removebg-preview.png" width="250px"
                                height="250px"></div>
                    </div>
                </div>
        </div>
        ...
        <div style="background-image: url(<?= base_url('assets/img/') ?>background.jpg);">
            ...
            <section class="py-5 blog-preview" id="produk">
                <div class="container px-5 my-5">
                    ...
                    <div class="row gx-5" data-aos="zoom-out">
                    ...
                    <!-- About section-->
                    <div class="about-container keunggulan" id="keunggulan">
                        <h1>
                            <hr>KEUNGGULAN
                            <hr>
                        </h1>
                    ...
                    <div class="about-container" id="tentang">
                        ...
                        <div class="row">
                            <div class="col-md-12 col4">
                                <div class="row gx-5 justify-content-center">
                                    <div class="text-center">
                                        <p> M Batik adalah toko baju dengan berbagai motif batik. M Batik memiliki
                                            produk dengan terbuat dari bahan berkualitas. M Batik menjual produk dengan
                                            harga yang terjangkau, namun kualitas yang dimiliki sangat berkualitas . M
                                            Batik memiliki online shop sehingga anda dapat membeli produk dari M Batik
                                            melalui online shop tersebut tanpa ribet.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="contact-container">
        <div class="row">
            ...
            <div class="col-md-4 contact-item">
                <h3>Sosial Media</h3>
                <hr>
                <a href="https://www.facebook.com/bu.mien.73"><img src="<?= base_url('assets/') ?>img/facebook.png"
                        width="100px" height="83px"></a>
                <a href="https://www.instagram.com/batikbumien/"><img src="<?= base_url('assets/') ?>img/instagram.png"
    ...
    <div class="copyrightText">
        <p>copyright © 2022 Online Tutorials. All Rights Reserved</p>
    </div>
